...
from Echo.music.views import AlbumDetailView, TrackDetailView
...
urlpatterns = [
    ...
    path('add_track_to_playlist/<int:playlist_id>/', views.AddTrackToPlaylistView.as_view(), name='add_track_to_playlist'),
